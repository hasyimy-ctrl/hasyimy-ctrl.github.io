...
/*	
    ...
    "12.00": {
        fw_status: "state=VERIFIED-on-hardware "
...
PS4["12.52"] = Object.assign({}, PS4["12.50"], {
    alias_of: "12.50",
    fw_status: "state=VERIFIED-on-hardware shares=12.50 "
...
/* 
Firmware 11.52 also reportedly confirmed working with the 11.50 offset by
by a 11.52 tester */

PS4["11.52"] = Object.assign({}, PS4["11.50"], {
    alias_of: "11.50",
    fw_status: "state=VERFIED-on-hardware shares=11.50 "
        + "webkit=confirmed-identical-to-11.50 (no 11.52 module dump) "
        + "kernel_rvas=confirmed-identical-to-11.50 "
        + "kpatch=1150.bin",
});
